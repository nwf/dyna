...
------------------------------------------------------------------------}}}
-- Instantiation States: Leq (≼) lattice                                {{{
...
--      5.3.8 (p98).
--
-- While never explicitly stated in the thesis, note that
--   @IFree True ≼ IFree False@
-- This agrees with both purposes above: unifying an allocated and an
-- un-allocated variable yields an allocated variable, and an un-allocated
-- variable may become allocated, just as it may become bound.
--
...
------------------------------------------------------------------------}}}
-- Instantiation States: Sub (⊑) lattice                                {{{
